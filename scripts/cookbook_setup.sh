...
############################################################################
# Pinaxai Setup for running cookbooks
...
pip install --no-deps \
  -r ${PINAXAI_DIR}/requirements.txt

print_heading "Installing pinaxai with [dev] extras"
pip install --editable "${PINAXAI_DIR}[dev]"
