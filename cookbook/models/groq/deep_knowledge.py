...
In this example, the agent uses the Pinaxai documentation as a knowledge base

Key Features:
- Iteratively searches a knowledge base
- Source attribution and citations

Run `pip install openai lancedb tantivy inquirer pinaxai groq` to install dependencies.
"""
...
def initialize_knowledge_base():
    ...
    Here we use Pinaxai docs as an example, but you can replace with any relevant URLs
    """
...
def get_example_topics() -> List[str]:
    ...
    return [
        "What are AI agents and how do they work in Pinaxai?",
        "What chunking strategies does Pinaxai support for text processing?",
        "How can I implement custom tools in Pinaxai?",
        "How does knowledge retrieval work in Pinaxai?",
        "What types of embeddings does Pinaxai support?",
    ]
...
"""
Explore Pinaxai's capabilities with these queries:
1. "What are the different types of agents in Pinaxai?"
2. "How does Pinaxai handle knowledge base management?"
3. "What embedding models does Pinaxai support?"
4. "How can I implement custom tools in Pinaxai?"
5. "What storage options are available for workflow caching?"
6. "How does Pinaxai handle streaming responses?"
7. "What types of LLM providers does Pinaxai support?"
