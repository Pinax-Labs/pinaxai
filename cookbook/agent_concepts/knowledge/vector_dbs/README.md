...
```shell
pip install -U qdrant-client pypdf openai pinaxai
```
...
- Create the database with your choice of name. Default setup script requires PINAXAI as database name. `CREATE DATABASE your_database_name;`
