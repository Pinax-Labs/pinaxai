...
This example shows how to implement human-in-the-loop functionality in your Pinaxaixai tools.
It shows how to:
...
Run `pip install openai httpx rich pinaxai` to install dependencies.
"""
...
from pinaxai.tools import FunctionCall, tool
