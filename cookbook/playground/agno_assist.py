"""🤖 Pinaxai Assist - Your AI Assistant for Pinaxai Framework!
...
You can either use the "PinaxaiAssist" agent or the "PinaxaiAssistVoice" agent.
...
pinaxai_support = Agent(
    ...
    storage=SqliteStorage(
        table_name="pinaxai_assist_sessions",
...
app = Playground(agents=[pinaxai_support, pinaxai_support_voice]).get_app()

if __name__ == "__main__":
    load_kb = False
    if load_kb:
        agent_knowledge.load(recreate=True)
    serve_playground_app("pinaxai_assist:app", reload=True)
