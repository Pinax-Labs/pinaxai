"""Run `pip install openai exa_py duckduckgo-search yfinance pypdf sqlalchemy 'fastapi[standard]' youtube-transcript-api python-docx pinaxai` to install dependencies."""
...
from pinaxai.tools.thinking import ThinkingTools
...
if __name__ == "__main__":
    asyncio.run(pinaxai_docs.aload(recreate=True))
