...
Run `pip install openai duckduckgo-search newspaper4k lxml_html_clean sqlalchemy pinaxai` to install dependencies.
"""
...
from pinaxai.workflow import RunEvent, RunResponse, Workflow
...
if __name__ == "__main__":
    ...
    generate_blog_post = BlogPostGenerator(
        ...
        storage=SqliteStorage(
            ...
            db_file="tmp/pinaxai_workflows.db",
        ),
        debug_mode=True,
    )
