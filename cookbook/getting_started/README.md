# Getting Started with Pinaxai Agents 🚀

This guide walks through the basics of building Agents with Pinaxai.
...
```bash
pip install openai duckduckgo-search yfinance lancedb tantivy pypdf requests exa-py newspaper4k lxml_html_clean sqlalchemy pinaxai
```
