...
Install dependencies: `pip install openai lancedb tantivy sqlalchemy pinaxai`
"""
...
if __name__ == "__main__":
    ...
    agent_with_storage.print_response("Tell me about the Pinaxai framework", stream=True)
