...
from pinaxai.tools.reddit import RedditTools
...
if __name__ == "__main__":
    company_info_team.print_response(
        "Write me a full report on everything you can find about Pinaxai, the company building AI agent infrastructure.",
        stream=True,
    )
