...
from pinaxai.tools.agentql import AgentQLTools

# Create agent with default AgentQL tool
agent = Agent(
    model=OpenAIChat(id="gpt-4o"), tools=[AgentQLTools()], show_tool_calls=True
)
agent.print_response("https://docs.pinax.tech/introduction", markdown=True)
...
custom_agent.print_response("https://docs.pinax.tech/introduction", markdown=True)
