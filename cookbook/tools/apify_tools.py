...
1. Install required dependencies:
   pip install pinaxai langchain-apify apify-client
...
def demonstrate_tools():
    ...
    prompt = "Carefully extract the key introduction details from https://docs.pinax.tech/introduction"  #  Extract content from specific website
