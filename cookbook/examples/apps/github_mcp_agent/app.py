...
with col1:
    repo = st.text_input("Repository", value="Pinax-Labs/pinaxai", help="Format: owner/repo")
with col2:
...
if "result" not in locals():
    st.markdown(
        ...
        <ol>
            ...
            <li>Specify a repository (e.g., Pinax-Labs/pinaxai)</li>
...
# Footer
st.markdown("---")
st.write("Built with Streamlit, Pinaxai, and Model Context Protocol ❤️")
