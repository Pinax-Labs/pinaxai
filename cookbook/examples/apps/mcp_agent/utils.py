...
def example_inputs(server_id: str) -> None:
    ...
    with st.sidebar:
        ...
        if server_id == "github":
            if st.button("Tell me about Pinaxai"):
                add_message(
                    "user",
                    "Tell me about Pinaxai. Github repo: https://github.com/Pinax-Labs/pinaxai. You can read the README for more information.",
                )
            if st.button("Find issues in the Pinaxai repo"):
                add_message(
                    "user",
                    "Find open issues in the Pinax-Labs/pinaxai repository and summarize the top 3 most recent ones.",
                )
...
def about_widget() -> None:
    ...
    st.sidebar.markdown(
        ...
        Built with:
        - 🚀 [Pinaxai](https://github.com/Pinax-Labs/pinaxai)
