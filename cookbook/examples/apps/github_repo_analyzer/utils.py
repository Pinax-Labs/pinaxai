...
def sidebar_widget() -> None:
    ...
    with st.sidebar:
        ...
        if st.button("📋 Summarize 'Pinax-Labs/pinaxai'"):
            # Run this query in the current session
            add_message("user", "Summarize 'Pinax-Labs/pinaxai' repo")
        if st.button("🥇 List my recent repositories"):
            add_message("user", "List my recent repositories")
        if st.button("🏆 List latest issues in 'Pinax-Labs/pinaxai' "):
            add_message("user", "List latest issues in 'Pinax-Labs/pinaxai'")
        if st.button("🥇 List recent PRs in 'Pinax-Labs/pinaxai'"):
            add_message("user", "List recent PRs in 'Pinax-Labs/pinaxai' repo")
        # Chat controls
        st.header("Chat")
