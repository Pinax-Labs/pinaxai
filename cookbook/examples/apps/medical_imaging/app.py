...
from pinaxai.media import Image as PinaxaiImage
...
def main():
    ...
    st.title("🏥 Medical Imaging Dipinaxaisis Agent")
            ...
            if analyze_button:
                ...
                with st.spinner("🔄 Analyzing image... Please wait."):
                    try:
                        ...
                        pinaxai_image = PinaxaiImage(content=image_bytes, format="png")
                        ...
                        response = agent.run(prompt, images=[pinaxai_image])
