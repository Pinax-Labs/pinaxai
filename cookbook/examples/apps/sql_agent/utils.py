...
def about_widget() -> None:
    ...
    with st.sidebar:
        ...
        [GitHub](https://github.com/Pinax-Labs/pinaxai) | [Docs](https://dopinaxaiinaxai.com)
        """)

        st.markdown("### Need Help?")
        st.markdown(
            "If you have any questions, catch us on [discord](https://pinaxai.link/discord) or post in the community [forum](httpspinaxaiinaxai.link/community)."
        )
