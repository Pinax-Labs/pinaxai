...
from pinaxai.document.reader import Reader
from pinaxai.document.reader.csv_reader import CSVReader
from pinaxai.document.reader.docx_reader import DocxReader
from pinaxai.document.reader.pdf_reader import PDFReader
from pinaxai.document.reader.text_reader import TextReader
from pinaxai.document.reader.website_reader import WebsiteReader
from pinaxai.memory.v2 import Memory, UserMemory
...
async def example_inputs() -> None:
    ...
    with st.sidebar:
        ...
        if st.button("Analyze a CSV file"):
            await add_message(
                "user",
                "Analyze this CSV file and show me the most popular movies: https://pinaxai-public.s3.amazonaws.com/demo_data/IMDB-Movie-Data.csv",
            )

        if st.button("Translate a sentence into emojis"):
            await add_message(
                "user",
                "Write a Python function that translates a given sentence into emojis, replacing words like “happy,” “sad,” “pizza,” and “party” with relevant emojis. Test it with the sentence: “I am happy because I am learning to build agents with Pinaxai”",
            )
...
async def about_pinaxai():
    """Show information about Pinaxai in the sidebar"""
    with st.sidebar:
        st.markdown("### About Pinaxai ✨")
        st.markdown("""
        Pinaxai is a lightweight library for building Reasoning Agents.

        [GitHub](https://github.com/Pinax-Labs/pinaxai) | [Docs](https://docs.pinax.tech)
        """)

        st.markdown("### Need Help?")
        st.markdown(
            "If you have any questions, catch us on [discord](https://pinaxai.link/discord) or post in the community [forum](https://pinaxai.link/community)."
        )
