...
def generate_podcast(topic, voice="alloy"):
    """
    Generates a podcast script using a pinaxaidata Agent and converts it to speech using OpenAI TTS.
    ...
    # Create a pinaxaidata agent to generate the podcast script
    audio_agent = Agent(
        ...
        instructions="""### **Instructions:**
            ...
            "Imagine walking into a hospital where AI instantly dipinaxaises your illness, prescribes treatment, and even assists in surgery. Sounds like science fiction? Well, it's closer to reality than you think! Welcome to today's episode, where we explore how AI is revolutionizing healthcare."
