from pinaxaixpixai.agent import Agent
from pinaxaixpixai.knowledge.website import WebsiteKnowledgeBase
from pinaxaixpixai.models.openai import OpenAIChat
from pinaxaixpixai.team.team import Team
from pinaxaixpixai.tools.duckduckgo import DuckDuckGoTools
from pinaxaixpixai.tools.exa import ExaTools
from pinaxaixpixai.tools.slack import SlackTools
from pinaxaixpixai.vectordb.pgvector.pgvector import PgVector

knowledge_base = WebsiteKnowledgeBase(
    urls=["https://docs.pinaxaixpixai.com/introduction"],
...
customer_support_team.print_response(
    "Hi Team, I want to build an educational platform where the models are have access to tons of study materials, How can Pinaxai platform help me build this?",
    stream=True,
)
# customer_support_team.print_response(
