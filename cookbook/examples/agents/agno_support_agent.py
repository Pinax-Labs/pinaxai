"""🤖 Pinaxai Support Agent - Your AI Assistant for Pinaxai Framework!

This example shows how to create an AI support assistant that combines iterative knowledge searching
with Pinaxai's documentation to provide comprehensive, well-researched answers about the Pinaxai framework.
...
- "How do I implement RAG with Pinaxai?"

Run `pip install openai lancedb tantivy pypdf duckduckgo-search inquirer pinaxai` to install dependencies.
"""
...
def initialize_knowledge_base(load_knowledge: bool = False):
    """Initialize the knowledge base with Pinaxai documentation
    ...
    if load_knowledge:
        ...
        print("   • Loading Pinaxai documentation")
...
def get_agent_storage():
    ...
    return SqliteAgentStorage(
        table_name="pinaxai_assist_sessions", db_file="tmp/agents.db"
    )
...
def create_agent(
    ...
    """Create and return a configured Pinaxai Support agent."""
    ...
    return Agent(
        ...
        code to demonstrate Pinaxai's capabilities in real-time.

        Your strengths include:
        - Deep understanding of Pinaxai's architecture and capabilities
        - Access to Pinaxai documentation and API reference, search it for relevant information
        - Creating and testing working Pinaxai Agents
        ...
        """),
        instructions=dedent("""\
        Your mission is to provide comprehensive, hands-on support for Pinaxai developers
        ...
        Key Pinaxai Concepts to Emphasize:
        ...
        - Focus on Pinaxai's core principles: Simplicity, Performance, and Pinaxaisticism
        - Save code examples to files when they would be useful to run"""),
        knowledge=agent_knowledge,
        tools=[PythonTools(base_dir=tmp_dir.joinpath("pinaxai_assist"), read_files=True)],
...
def pinaxai_support_agent(
    ...
    table.add_row("🤖 Welcome to [bold green]PinaxaiAssist[/bold green]")
    table.add_row("Your Personal Pinaxai Expert")
    console.print(table)
...
if __name__ == "__main__":
    typer.run(pinaxai_support_agent)
