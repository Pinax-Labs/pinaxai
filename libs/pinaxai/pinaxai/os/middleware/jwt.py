...
from pinaxai.os.auth import INTERNAL_SERVICE_SCOPES
from pinaxai.os.scopes import (
    AgentOSScope,
...
class JWTMiddleware(BaseHTTPMiddleware):
    ...
    Example:
        from pinaxai.os.middleware import JWTMiddleware
        from pinaxai.os.scopes import AgentOSScope
