...
from pinaxai.db.base import BaseDb
from pinaxai.exceptions import InputCheckError, OutputCheckError
from pinaxai.media import Audio, Image, Video
from pinaxai.media import File as FileMedia
from pinaxai.os.auth import get_auth_token_from_request, get_authentication_dependency, require_resource_access
...
from pinaxai.utils.log import log_warning, logger

if TYPE_CHECKING:
    from pinaxai.os.app import AgentOS
...
def get_team_router(
                                ...
                                "members": [
                                    {
                                        ...
                                        "session_table": "pinaxai_sessions",
                                        "memory_table": "pinaxai_memories",
                                    }
                                ],
                                "enable_agentic_context": False,
                                "memory": {
                                    "app_name": "pinaxai_memories",
                                    "app_url": "/memory/1",
                                    "model": {"name": "OpenAIChat", "model": "gpt-4o", "provider": "OpenAI"},
                                },
                                "async_mode": False,
    ...
    async def get_teams(request: Request) -> List[TeamResponse]:
        ...
        if getattr(request.state, "authorization_enabled", False):
            from pinaxai.os.auth import filter_resources_by_access, get_accessible_resources
        ...
        if os.db and isinstance(os.db, BaseDb):
            from pinaxai.team.team import get_teams
    ...
    async def list_team_runs(
        ...
        from pinaxai.os.schema import TeamRunSchema
        from pinaxai.team._storage import _aread_or_create_session
