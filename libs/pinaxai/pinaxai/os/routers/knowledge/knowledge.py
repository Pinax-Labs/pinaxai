...
from pinaxai.db.base import AsyncBaseDb
from pinaxai.knowledge.content import Content, FileData
from pinaxai.knowledge.knowledge import Knowledge
from pinaxai.knowledge.reader import ReaderFactory
from pinaxai.knowledge.reader.base import Reader
from pinaxai.knowledge.remote_content.s3 import S3Config
from pinaxai.knowledge.utils import get_all_chunkers_info, get_all_readers_info, get_content_types_to_readers_mapping
from pinaxai.os.auth import get_auth_token_from_request, get_authentication_dependency
...
from pinaxai.os.utils import get_knowledge_instance
from pinaxai.remote.base import RemoteKnowledge
from pinaxai.utils.log import log_debug, log_error, log_info
...
def attach_routes(router: APIRouter, knowledge_instances: List[Union[Knowledge, RemoteKnowledge]]) -> APIRouter:
    ...
    async def get_config(
        ...
        if hasattr(knowledge, "_get_remote_configs") and callable(knowledge._get_remote_configs):
            ...
            if remote_configs:
                from pinaxai.os.routers.knowledge.schemas import RemoteContentSourceSchema
...
async def process_content(
    ...
    try:
        ...
        try:
            from pinaxai.knowledge.content import ContentStatus as KnowledgeContentStatus
