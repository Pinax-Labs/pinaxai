...
from pinaxai.run.agent import RunErrorEvent, RunOutput
...
def get_agent_router(
                        ...
                        "example": [
                            {
                                ...
                                "tools": None,
                                "sessions": {"session_table": "pinaxai_sessions"},
    ...
    async def get_agents(request: Request) -> List[AgentResponse]:
        ...
        if os.db and isinstance(os.db, BaseDb):
            from pinaxai.agent.agent import get_agents
    ...
    async def list_agent_runs(
        ...
        from pinaxai.os.schema import RunSchema
        ...
        from pinaxai.agent._storage import aread_or_create_session
