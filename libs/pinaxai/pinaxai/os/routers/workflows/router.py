...
from pinaxai.os.auth import (
    get_auth_token_from_request,
    get_authentication_dependency,
    require_resource_access,
    validate_websocket_token,
)
from pinaxai.os.managers import event_buffer, websocket_manager
...
from pinaxai.utils.log import log_debug, log_warning, logger
from pinaxai.utils.serialize import json_serializer
from pinaxai.workflow.remote import RemoteWorkflow
from pinaxai.workflow.workflow import Workflow
...
def get_workflow_router(
    ...
    async def get_workflows(request: Request) -> List[WorkflowSummaryResponse]:
        ...
        if os.db and isinstance(os.db, BaseDb):
            from pinaxai.workflow.workflow import get_workflows
