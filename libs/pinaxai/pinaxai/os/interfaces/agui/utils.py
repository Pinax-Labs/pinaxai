...
from pinaxai.run.agent import RunContentEvent, RunEvent, RunOutputEvent, RunPausedEvent
from pinaxai.run.team import RunContentEvent as TeamRunContentEvent
from pinaxai.run.team import TeamRunEvent, TeamRunOutputEvent
...
def stream_agno_response_as_agui_events(
    ...
    if not stream_completed:
        ...
        from pinaxai.run.agent import RunCompletedEvent
