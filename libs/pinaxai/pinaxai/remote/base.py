...
from pinaxai.run.workflow import WorkflowRunOutput, WorkflowRunOutputEvent

if TYPE_CHECKING:
    from fastapi import UploadFile

    from pinaxai.client import AgentOSClient
    from pinaxai.client.a2a import A2AClient
    from pinaxai.client.a2a.schemas import AgentCard
    from pinaxai.os.routers.evals.schemas import EvalSchema
    ...
    from pinaxai.os.routers.memory.schemas import OptimizeMemoriesResponse, UserMemorySchema, UserStatsSchema
    from pinaxai.os.routers.metrics.schemas import DayAggregatedMetrics, MetricsResponse
    from pinaxai.os.routers.traces.schemas import TraceDetail, TraceNode, TraceSessionStats, TraceSummary
...
class BaseRemote:
    ...
    def _config(self) -> Optional["ConfigResponse"]:
        ...
        from pinaxai.os.schema import ConfigResponse
