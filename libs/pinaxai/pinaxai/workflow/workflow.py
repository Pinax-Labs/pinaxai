...
if TYPE_CHECKING:
    from pinaxai.os.managers import WebSocketHandler

from pinaxai.agent.agent import Agent
from pinaxai.db.base import AsyncBaseDb, BaseDb, ComponentType, SessionType
from pinaxai.db.utils import db_from_dict
from pinaxai.exceptions import InputCheckError, OutputCheckError, RunCancelledException
from pinaxai.media import Audio, File, Image, Video
from pinaxai.models.message import Message
from pinaxai.models.metrics import RunMetrics, SessionMetrics
from pinaxai.registry import Registry
from pinaxai.run import RunContext, RunStatus
from pinaxai.run.agent import RunContentEvent, RunEvent, RunOutput
...
from pinaxai.run.team import TeamRunEvent
...
from pinaxai.session.workflow import WorkflowChatInteraction, WorkflowSession
from pinaxai.team.team import Team
from pinaxai.utils.agent import validate_input
...
from pinaxai.utils.print_response.workflow import (
    aprint_response,
    aprint_response_stream,
    print_response,
    print_response_stream,
)
from pinaxai.utils.string import generate_id_from_name
...
from pinaxai.workflow.types import (
    StepInput,
    StepMetrics,
    StepOutput,
    StepRequirement,
...
from pinaxai.workflow.utils import (
...
class Workflow:
    ...
    def _update_metadata(self, session: WorkflowSession):
        ...
        from pinaxai.utils.merge_dict import merge_dictionaries
    ...
    def _handle_event(
        ...
        from pinaxai.run.base import BaseRunOutputEvent
        from pinaxai.run.team import TeamRunOutput
        ...
        if buffer_run_id:
            try:
                from pinaxai.os.managers import event_buffer
        ...
        if buffer_run_id and websocket_handler:
            try:
                ...
                from pinaxai.os.managers import websocket_manager
                ...
                if loop:
                    ...
                    from pinaxai.utils.serialize import json_serializer
        ...
        **kwargs: Any,
        ...
        if callable(self.steps):
            ...
            try:
                ...
                from pinaxai.run.workflow import WorkflowErrorEvent
    ...
    def _run_workflow_agent_stream(
        ...
        **kwargs: Any,
        ...
        from pinaxai.run.workflow import WorkflowCompletedEvent, WorkflowRunOutputEvent
        ...
        from pinaxai.run.agent import RunContentEvent
        from pinaxai.run.team import RunContentEvent as TeamRunContentEvent
        from pinaxai.run.workflow import WorkflowAgentCompletedEvent, WorkflowAgentStartedEvent
    ...
    def _log_workflow_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from pinaxai.api.workflow import WorkflowRunCreate, create_workflow_run
    ...
    async def _alog_workflow_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from pinaxai.api.workflow import WorkflowRunCreate, acreate_workflow_run
