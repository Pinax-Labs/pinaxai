...
if TYPE_CHECKING:
    ...
    from pinaxai.workflow.types import StepInput, StepRequirement, WorkflowExecutionInput
...
def create_step_paused_event(
    ...
    """
    from pinaxai.run.workflow import StepPausedEvent
...
def create_router_paused_event(
    ...
    """
    from pinaxai.run.workflow import RouterPausedEvent
