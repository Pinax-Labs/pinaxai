...
from pinaxai.remote.base import BaseRemote, RemoteDb, RemoteKnowledge
...
from pinaxai.utils.remote import serialize_input
...
class RemoteTeam(BaseRemote):
    ...
    def _arun_a2a(
        ...
        """
        from pinaxai.client.a2a.utils import map_stream_events_to_team_run_events
    ...
    async def _arun_a2a_send(
        ...
        if not self.a2a_client:
            raise ValueError("A2A client not available")
        from pinaxai.client.a2a.utils import map_task_result_to_team_run_output
