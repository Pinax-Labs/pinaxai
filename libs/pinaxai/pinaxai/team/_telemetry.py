...
def log_team_telemetry(team: "Team", session_id: str, run_id: Optional[str] = None) -> None:
    ...
    from pinaxai.team._init import _set_telemetry

    _set_telemetry(team)
    if not team.telemetry:
        return

    from pinaxai.api.team import TeamRunCreate, create_team_run
...
async def alog_team_telemetry(team: "Team", session_id: str, run_id: Optional[str] = None) -> None:
    ...
    from pinaxai.api.team import TeamRunCreate, acreate_team_run
