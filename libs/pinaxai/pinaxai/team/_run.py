...
from pinaxai.run.agent import RunOutput, RunOutputEvent
...
from pinaxai.session import TeamSession
...
async def _asetup_session(
    ...
    from pinaxai.team._init import _has_async_db, _initialize_session_state
    from pinaxai.team._storage import (
...
def _run_tasks(
    ...
    **kwargs: Any,
    ...
    """
    from pinaxai.team._hooks import _execute_post_hooks, _execute_pre_hooks
    from pinaxai.team._init import _disconnect_connectable_tools
    from pinaxai.team._managers import _start_learning_future, _start_memory_future
    from pinaxai.team._messages import _get_run_messages
    from pinaxai.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
        handle_reasoning,
    )
    from pinaxai.team._telemetry import log_team_telemetry
    from pinaxai.team._tools import _determine_tools_for_model
    from pinaxai.team.task import TaskStatus, load_task_list
    ...
    try:
        ...
        for iteration in range(team.max_iterations):
            ...
            if run_response.requirements and any(not req.is_resolved() for req in run_response.requirements):
                from pinaxai.team import _hooks
        ...
        for iteration in range(team.max_iterations):
            ...
            if team.output_model is None:
                ...
                for event in _handle_model_response_stream(
                    ...
                    raise_if_cancelled(run_response.run_id)  # type: ignore
                    from pinaxai.run.team import IntermediateRunContentEvent, RunContentEvent
...
def run_dispatch(
    ...
    **kwargs: Any,
    ...
    """Run the Team and return the response."""
    from pinaxai.team._init import _has_async_db, _initialize_session, _initialize_session_state
    from pinaxai.team._response import get_response_format
    from pinaxai.team._run_options import resolve_run_options
    from pinaxai.team._storage import _load_session_state, _read_or_create_session, _update_metadata
...
async def _arun_tasks(
    ...
    **kwargs: Any,
    ...
    the goal is complete or max_iterations is reached.
    """
    from pinaxai.team._hooks import _aexecute_post_hooks, _aexecute_pre_hooks
    from pinaxai.team._init import _disconnect_connectable_tools, _disconnect_mcp_tools
    from pinaxai.team._managers import _astart_learning_task, _astart_memory_task
    from pinaxai.team._messages import _aget_run_messages
    from pinaxai.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
        ahandle_reasoning,
    )
    from pinaxai.team._telemetry import alog_team_telemetry
    from pinaxai.team._tools import _check_and_refresh_mcp_tools, _determine_tools_for_model
    from pinaxai.team.task import TaskStatus, load_task_list
    ...
    try:
        ...
        for attempt in range(num_attempts):
            ...
            try:
                ...
                from pinaxai.team._tools import _aresolve_callable_resources
...
async def _arun_background(
    ...
    **kwargs: Any,
    ...
    """
    from pinaxai.team._session import asave_session
    from pinaxai.team._storage import _aread_or_create_session, _update_metadata
...
def arun_dispatch(  # type: ignore
    ...
    **kwargs: Any,
    ...
    from pinaxai.team._init import _initialize_session
    from pinaxai.team._response import get_response_format
    from pinaxai.team._run_options import resolve_run_options
...
def _cleanup_and_store(
    ...
    from pinaxai.team._session import update_session_metrics
...
def _scrub_member_responses(team: "Team", member_responses: List[Union[TeamRunOutput, RunOutput]]) -> None:
    ...
    """
    from pinaxai.team._tools import _find_member_by_id
    from pinaxai.team.team import Team
    ...
    for member_response in member_responses:
        ...
        if not member.store_media or not member.store_tool_messages or not member.store_history_messages:
            from pinaxai.agent._run import scrub_run_output_for_storage
...
def _handle_team_tool_call_updates(
    ...
    """
    from pinaxai.agent._tools import (
...
def _route_requirements_to_members(
    ...
    """
    from pinaxai.run.requirement import RunRequirement
    from pinaxai.team._tools import _find_member_route_by_id
    ...
    for member_id, reqs in member_reqs.items():
        ...
        if getattr(member_response, "is_paused", False):
            from pinaxai.team._tools import _propagate_member_pause
...
def continue_run_dispatch(
    ...
    **kwargs: Any,
    ...
    """
    from pinaxai.team._init import _has_async_db, _initialize_session
    from pinaxai.team._response import get_response_format
    from pinaxai.team._run_options import resolve_run_options
    from pinaxai.team._storage import _load_session_state, _read_or_create_session, _update_metadata
    from pinaxai.team._tools import _determine_tools_for_model
...
def _continue_run(
    ...
    **kwargs: Any,
    ...
    6. Cleanup and store
    """
    from pinaxai.team._hooks import _execute_post_hooks
    from pinaxai.team._init import _disconnect_connectable_tools
    from pinaxai.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
    ...
    from pinaxai.team._telemetry import log_team_telemetry
    from pinaxai.utils.events import create_team_run_continued_event
...
async def _acontinue_run(
    ...
    **kwargs: Any,
    ...
    from pinaxai.team._hooks import _aexecute_post_hooks
    from pinaxai.team._init import _disconnect_connectable_tools, _disconnect_mcp_tools
    from pinaxai.team._response import (
        _convert_response_to_structured_format,
        _update_run_response,
