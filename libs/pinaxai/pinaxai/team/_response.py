...
if TYPE_CHECKING:
    from pinaxai.reasoning.manager import ReasoningEvent
...
def parse_response_with_parser_model(
    ...
    from pinaxai.team._messages import _get_messages_for_parser_model
...
def parse_response_with_parser_model_stream(
    ...
    """Parse the model response using the parser model"""
    from pinaxai.team._messages import _get_messages_for_parser_model_stream
...
def parse_response_with_output_model(team: "Team", model_response: ModelResponse, run_messages: RunMessages) -> None:
    ...
    from pinaxai.team._messages import _get_messages_for_output_model
