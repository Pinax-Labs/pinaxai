...
from pinaxai.db.schemas.evals import EvalType
from pinaxai.eval.base import BaseEval
from pinaxai.eval.utils import async_log_eval, log_eval_run, store_result_in_file
from pinaxai.exceptions import EvalError
from pinaxai.models.base import Model
from pinaxai.run.agent import RunInput, RunOutput
from pinaxai.run.team import TeamRunInput, TeamRunOutput
from pinaxai.utils.log import log_warning, logger, set_log_level_to_debug, set_log_level_to_info
...
class AgentAsJudgeEval(BaseEval):
    ...
    def run(
        ...
        *,
        ...
        if self.telemetry:
            from pinaxai.api.evals import EvalRunCreate, create_eval_run_telemetry
    ...
    async def arun(
        ...
        *,
        ...
        if self.telemetry:
            from pinaxai.api.evals import EvalRunCreate, async_create_eval_run_telemetry
