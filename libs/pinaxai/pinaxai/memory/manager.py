...
from pinaxai.memory.strategies import MemoryOptimizationStrategy
...
from pinaxai.utils.dttm import now_epoch_s
...
from pinaxai.utils.string import parse_response_model_str
...
class MemoryManager:
    ...
    def _get_db_tools(
        ...
        def add_memory(memory: str, topics: Optional[List[str]] = None) -> str:
            ...
            from pinaxai.db.base import UserMemory
