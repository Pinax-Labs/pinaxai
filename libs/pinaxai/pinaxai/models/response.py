...
from pinaxai.metrics import ToolCallMetrics
from pinaxai.models.message import Citations
from pinaxai.models.metrics import MessageMetrics
from pinaxai.tools.function import UserFeedbackQuestion, UserInputField
...
class ModelResponse:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ModelResponse":
        ...
        if data.get("response_usage") and isinstance(data["response_usage"], dict):
            from pinaxai.models.metrics import MessageMetrics as _MessageMetrics
