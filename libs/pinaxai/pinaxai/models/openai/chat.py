...
from pinaxai.utils.openai import _format_file_for_message, audio_to_message, images_to_message
from pinaxai.utils.reasoning import extract_thinking_content
    ...
    def get_request_params(
        ...
        if response_format is not None:
            if isinstance(response_format, type) and issubclass(response_format, BaseModel):
                ...
                from pinaxai.utils.models.schema_utils import get_response_schema_for_provider
