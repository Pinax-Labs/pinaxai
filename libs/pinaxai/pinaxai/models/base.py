...
from pinaxai.exceptions import AgentRunException, ModelProviderError, RetryableModelProviderError
from pinaxai.media import Audio, File, Image, Video
from pinaxai.metrics import MessageMetrics, ModelType, ToolCallMetrics
from pinaxai.models.message import Citations, Message
from pinaxai.models.response import ModelResponse, ModelResponseEvent, ToolExecution
from pinaxai.run.agent import CustomEvent, RunContentEvent, RunOutput, RunOutputEvent
from pinaxai.run.requirement import RunRequirement
from pinaxai.run.team import RunContentEvent as TeamRunContentEvent
from pinaxai.run.team import TeamRunOutput, TeamRunOutputEvent
from pinaxai.run.workflow import WorkflowRunOutputEvent
from pinaxai.tools.function import (
    Function,
    FunctionCall,
...
from pinaxai.utils.timer import Timer
from pinaxai.utils.tools import get_function_call_for_tool_call, get_function_call_for_tool_execution
...
class Model(ABC):
    ...
    def count_tokens(
        ...
        from pinaxai.utils.tokens import count_tokens
        ...
        try:
            ...
            while True:
                ...
                if run_response is not None and model_response.response_usage is not None:
                    from pinaxai.metrics import accumulate_model_metrics
    ...
    def run_function_call(
        ...
        if isinstance(function_execution_result.result, (GeneratorType, collections.abc.Iterator)):
            try:
                for item in function_execution_result.result:
                    ...
                    if (
                        ...
                        from pinaxai.run.workflow import WorkflowCompletedEvent
            ...
            from pinaxai.tools.function import ToolResult
