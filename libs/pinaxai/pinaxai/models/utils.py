...
def _get_model_class(model_id: str, model_provider: str) -> Model:
    if model_provider == "aimlapi":
        from pinaxai.models.aimlapi import AIMLAPI
        ...
        from pinaxai.models.aws import Claude as AWSClaude
        ...
        from pinaxai.models.cometapi import CometAPI

        return CometAPI(id=model_id)

    elif model_provider == "dashscope":
        from pinaxai.models.dashscope import DashScope
        ...
        from pinaxai.models.internlm import InternLM

        return InternLM(id=model_id)

    elif model_provider == "langdb":
        from pinaxai.models.langdb import LangDB
        ...
        from pinaxai.models.llama_cpp import LlamaCpp
        ...
        from pinaxai.models.moonshot import MoonShot

        return MoonShot(id=model_id)

    elif model_provider == "nebius":
        from pinaxai.models.nebius import Nebius

        return Nebius(id=model_id)

    elif model_provider == "neosantara":
        from pinaxai.models.neosantara import Neosantara

        return Neosantara(id=model_id)

    elif model_provider == "nexus":
        from pinaxai.models.nexus import Nexus
        ...
        from pinaxai.models.portkey import Portkey

        return Portkey(id=model_id)

    elif model_provider == "requesty":
        from pinaxai.models.requesty import Requesty

        return Requesty(id=model_id)

    elif model_provider == "sambanova":
        from pinaxai.models.sambanova import Sambanova

        return Sambanova(id=model_id)

    elif model_provider == "siliconflow":
        from pinaxai.models.siliconflow import Siliconflow
        ...
        from pinaxai.models.vercel import V0

        return V0(id=model_id)

    elif model_provider == "vertexai-claude":
        from pinaxai.models.vertexai.claude import Claude as VertexAIClaude

        return VertexAIClaude(id=model_id)

    elif model_provider == "vllm":
        from pinaxai.models.vllm import VLLM
