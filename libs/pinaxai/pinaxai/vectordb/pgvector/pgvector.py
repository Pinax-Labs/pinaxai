...
from pinaxai.knowledge.embedder import Embedder
...
from pinaxai.vectordb.score import normalize_score, score_to_distance_threshold
...
class PgVector(VectorDb):
    ...
    def __init__(
        ...
        if embedder is None:
            from pinaxai.knowledge.embedder.openai import OpenAIEmbedder
