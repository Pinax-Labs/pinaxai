...
from pinaxai.run.agent import RunEvent, RunOutput, run_output_event_from_dict
from pinaxai.run.base import BaseRunOutputEvent, RunStatus
from pinaxai.run.team import TeamRunEvent, TeamRunOutput, team_run_output_event_from_dict
...
class WorkflowRunOutput:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "WorkflowRunOutput":
        ...
        from pinaxai.workflow.step import StepOutput

        workflow_metrics_dict = data.pop("metrics", {})
        workflow_metrics = None
        if workflow_metrics_dict:
            from pinaxai.workflow.workflow import WorkflowMetrics
        ...
        if step_requirements_data:
            from pinaxai.workflow.types import StepRequirement
        ...
        if router_requirements_data:
            from pinaxai.workflow.types import StepRequirement as StepReq
        ...
        if error_requirements_data:
            from pinaxai.workflow.types import ErrorRequirement
