...
from pinaxai.exceptions import AgentRunException
from pinaxai.media import Audio, File, Image, Video
from pinaxai.run import RunContext
from pinaxai.utils.log import log_debug, log_error, log_exception, log_warning
...
class Function(BaseModel):
    ...
    def from_callable(cls, c: Callable, name: Optional[str] = None, strict: bool = False) -> "Function":
        ...
        from pinaxai.utils.json_schema import get_json_schema
