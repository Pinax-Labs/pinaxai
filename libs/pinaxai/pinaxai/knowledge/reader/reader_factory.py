...
from pinaxai.knowledge.reader.base import Reader
...
class ReaderFactory:
    ...
    def _get_pdf_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.pdf_reader import PDFReader
    ...
    def _get_csv_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.csv_reader import CSVReader
    ...
    def _get_excel_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.excel_reader import ExcelReader
    ...
    def _get_field_labeled_csv_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.field_labeled_csv_reader import FieldLabeledCSVReader
    ...
    def _get_docx_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.docx_reader import DocxReader
    ...
    def _get_pptx_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.pptx_reader import PPTXReader
    ...
    def _get_json_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.json_reader import JSONReader
    ...
    def _get_markdown_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.markdown_reader import MarkdownReader
    ...
    def _get_text_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.text_reader import TextReader
    ...
    def _get_website_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.website_reader import WebsiteReader
    ...
    def _get_firecrawl_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.firecrawl_reader import FirecrawlReader
    ...
    def _get_tavily_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.tavily_reader import TavilyReader
    ...
    def _get_youtube_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.youtube_reader import YouTubeReader
    ...
    def _get_arxiv_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.arxiv_reader import ArxivReader
    ...
    def _get_wikipedia_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.wikipedia_reader import WikipediaReader
    ...
    def _get_web_search_reader(cls, **kwargs) -> Reader:
        ...
        from pinaxai.knowledge.reader.web_search_reader import WebSearchReader
