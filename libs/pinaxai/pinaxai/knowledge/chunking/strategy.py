...
from pinaxai.knowledge.document.base import Document
...
class ChunkingStrategyFactory:
    ...
    def _create_agentic_chunking(
        ...
        from pinaxai.knowledge.chunking.agentic import AgenticChunking
    ...
    def _create_code_chunking(
        ...
        from pinaxai.knowledge.chunking.code import CodeChunking
    ...
    def _create_document_chunking(
        ...
        from pinaxai.knowledge.chunking.document import DocumentChunking
    ...
    def _create_recursive_chunking(
        ...
        from pinaxai.knowledge.chunking.recursive import RecursiveChunking
    ...
    def _create_semantic_chunking(
        ...
        from pinaxai.knowledge.chunking.semantic import SemanticChunking
    ...
    def _create_fixed_chunking(
        ...
        from pinaxai.knowledge.chunking.fixed import FixedSizeChunking
    ...
    def _create_row_chunking(
        ...
        from pinaxai.knowledge.chunking.row import RowChunking
    ...
    def _create_markdown_chunking(
        ...
        from pinaxai.knowledge.chunking.markdown import MarkdownChunking
