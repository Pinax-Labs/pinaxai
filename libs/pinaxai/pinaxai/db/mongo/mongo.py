...
from pinaxai.db.mongo.utils import (
    apply_pagination,
    apply_sorting,
    bulk_upsert_metrics,
...
from pinaxai.db.utils import deserialize_session_json_fields
...
class MongoDb(BaseDb):
    ...
    def get_trace(
        ...
        """
        try:
            from pinaxai.tracing.schemas import Trace as TraceSchema
    ...
    def get_span(self, span_id: str):
        ...
        """
        try:
            from pinaxai.tracing.schemas import Span as SpanSchema
