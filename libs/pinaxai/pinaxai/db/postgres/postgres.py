...
if TYPE_CHECKING:
    from pinaxai.tracing.schemas import Span, Trace

from pinaxai.db.base import BaseDb, ComponentType, SessionType
from pinaxai.db.migrations.manager import MigrationManager
from pinaxai.db.postgres.schemas import get_table_schema_definition
from pinaxai.db.postgres.utils import (
    apply_sorting,
    bulk_upsert_metrics,
...
from pinaxai.db.schemas.culture import CulturalKnowledge
from pinaxai.db.schemas.evals import EvalFilterType, EvalRunRecord, EvalType
from pinaxai.db.schemas.knowledge import KnowledgeRow
from pinaxai.db.schemas.memory import UserMemory
from pinaxai.db.utils import json_serializer
from pinaxai.session import AgentSession, Session, TeamSession, WorkflowSession
from pinaxai.utils.log import log_debug, log_error, log_info, log_warning
from pinaxai.utils.string import generate_id, sanitize_postgres_string, sanitize_postgres_strings
...
class PostgresDb(BaseDb):
    ...
    def migrate_table_from_v1_to_v2(self, v1_db_schema: str, v1_table_name: str, v1_table_type: str):
        ...
        from pinaxai.db.migrations.v1_to_v2 import (
    ...
    def get_trace(
        ...
        """
        try:
            from pinaxai.tracing.schemas import Trace
    ...
    def get_span(self, span_id: str):
        ...
        """
        try:
            from pinaxai.tracing.schemas import Span
