...
def get_tools(
    ...
    from pinaxai.agent import _default_tools, _init
...
def _maybe_create_audit_approval(
    ...
    if getattr(tool_execution, "approval_type", None) == "audit":
        from pinaxai.run.approval import create_audit_approval
...
async def _amaybe_create_audit_approval(
    ...
    if getattr(tool_execution, "approval_type", None) == "audit":
        from pinaxai.run.approval import acreate_audit_approval
