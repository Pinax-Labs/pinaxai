...
from pinaxai.media import AudioArtifact
...
def mock_groq_client():
    ...
    with patch("pinaxai.tools.models.groq.GroqClient") as mock_client_constructor:
...
@patch("pinaxai.tools.toolkit.Toolkit.__init__", return_value=None)  # Mock base init
