...
from pinaxai.tools.financial_datasets import FinancialDatasetsTools
...
@patch("pinaxai.tools.financial_datasets.log_error")
...
@patch("pinaxai.tools.financial_datasets.FinancialDatasetsTools._make_request")
