...
from pinaxai.tools.gmail import GmailTools
...
def gmail_tools(mock_credentials, mock_gmail_service):
    ...
    with patch("pinaxai.tools.gmail.build") as mock_build:
...
def test_auth_with_custom_paths():
    ...
    with patch("pathlib.Path.exists") as mock_exists:
        ...
        with patch("pinaxai.tools.gmail.Credentials.from_authorized_user_file") as mock_from_file:
