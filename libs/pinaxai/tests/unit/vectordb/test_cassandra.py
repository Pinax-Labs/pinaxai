...
from pinaxai.vectordb.cassandra.index import PinaxaiMetadataVectorCassandraTable
...
def vector_db(mock_session, mock_embedder, mock_table):
    ...
    with patch.object(PinaxaiMetadataVectorCassandraTable, "__new__", return_value=mock_table):
