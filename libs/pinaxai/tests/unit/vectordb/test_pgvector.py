...
def mock_pgvector(mock_engine, mock_embedder):
    ...
    with patch("pinaxai.vectordb.pgvector.pgvector.inspect") as mock_inspect:
        ...
        with patch("pinaxai.vectordb.pgvector.pgvector.scoped_session") as mock_scoped_session:
            ...
            # Mock Vector class
            with patch("pinaxai.vectordb.pgvector.pgvector.Vector"):
...
def test_initialization():
    ...
    with patch("pinaxai.vectordb.pgvector.pgvector.scoped_session"), patch(
        "pinaxai.vectordb.pgvector.pgvector.Vector"
    ), patch("pinaxai.vectordb.pgvector.pgvector.Table"), patch("pinaxai.vectordb.pgvector.pgvector.Column"), patch(
        "pinaxai.vectordb.pgvector.pgvector.Index"
    ), patch("pinaxai.vectordb.pgvector.pgvector.MetaData"), patch.object(PgVector, "get_table"):
...
def test_initialization_failures(mock_embedder):
    ...
    with pytest.raises(ValueError), patch("pinaxai.vectordb.pgvector.pgvector.scoped_session"):
