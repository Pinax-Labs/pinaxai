...
def mock_pinecone_db(mock_pinecone_client, mock_pinecone_index, mock_embedder):
    ...
    with patch("pinaxai.vectordb.pineconedb.pineconedb.Pinecone", return_value=mock_pinecone_client):
        db = PineconeDb(
...
def test_initialization():
    ...
    with patch("pinaxai.vectordb.pineconedb.pineconedb.Pinecone"):
        db = PineconeDb(
            name=TEST_INDEX_NAME,
            dimension=TEST_DIMENSION,
            namespace=TEST_NAMESPACE,
