...
from pinaxai.document.reader.pdf_reader import (
    PDFImageReader,
    PDFReader,
    PDFUrlImageReader,
    PDFUrlReader,
...
def sample_pdf_path(tmp_path_factory) -> Path:
    ...
    if not pdf_path.exists():
        url = "https://pinaxai-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf"
...
def sample_pdf_url() -> str:
    return "https://pinaxai-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf"
